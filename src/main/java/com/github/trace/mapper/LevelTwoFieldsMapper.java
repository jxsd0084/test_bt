...
public interface LevelTwoFieldsMapper extends ICrudMapper< LevelTwoFields > {
	...
	@Select( "SELECT L2.id,L2.level1_field_id,L2.level1_field_name,L2.level1_field_tag,L2.level2_field_desc,L2.level2_field_name from level_one_fields as L1 INNER JOIN level_two_fields as L2 ON L1.id = L2.level1_field_id WHERE L1.navigation_id= #{navigation_id} and L2.status = 1" )
