...
public interface BuriedPointMapper extends ICrudMapper<BuriedPoint> {
  ...
  @Update("Update buried_point set bp_name=#{bp_name},bp_value=#{bp_value},bp_value_desc=#{bp_value_desc},is_checked=#{is_checked} where id=#{id}")
  boolean updateBuriedPoint(@Param("bp_name") String bp_name, @Param("bp_value") String bp_value,@Param("bp_value_desc") String bp_value_desc,@Param("is_checked") boolean is_checked,@Param("id") int id);
