...
public class RecordStatisticsController {
	...
	public
	@ResponseBody
	List< Map< String, Object > > buriedPointCount( @RequestParam( "navigationId" ) int navigationId,
...
//       }
	...
	public
	@ResponseBody
	List< LevelOneFields > searchOneLevel( @RequestParam( "navigationId" ) int navigationId ) {
	...
	public
	@ResponseBody
	List< LevelTwoFields > searchTwoLevel( @RequestParam( "levelOneId" ) int levelOneId ) {
	...
	public
	@ResponseBody
	String searchBuriedPoint( @RequestParam( "navigationId" ) int navigationId ) {
